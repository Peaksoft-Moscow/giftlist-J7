INSERT INTO users(role, shoes_size, clothes_size, country, social_media, birthday, email, hobby, important,
                  last_name, name,
                  password, phone_number, subscribe, activation_code, active)
...
INSERT INTO bookings(gift_name, id, create_date, booking_status, user_id)
VALUES ('gifts', 1, '2023-12-20', 'UNBOOKED', 1);

INSERT INTO gifts(add_date, booking_status, condition, date_of_holiday, gift_status, category_id,
                  user_id, description, name, holiday_id)
VALUES ('2023-12-29', 'UNBOOKED', 'NEW', '2023-12-31', 'WISHLIST', 1, 1, 'gift to my friend', 'Telephone', 1),
       ('2023-12-29', 'BOOKED', 'NEW', '2023-12-31', 'CHARITY', 1, 2, 'gift to my friend', 'Telephone', 1),
       ('2023-12-29', 'UNBOOKED', 'NEW', '2023-12-31', 'CHARITY', 1, 2, 'gift to my friend', 'Telephone', 1),
       ('2023-12-29', 'UNBOOKED', 'NEW', '2023-12-31', 'WISHLIST', 1, 1, 'gift to my friend', 'Telephone', 1);
